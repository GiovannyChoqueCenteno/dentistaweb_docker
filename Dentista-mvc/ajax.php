...
require_once  BASE_PATH .   "controlador/PacienteController.php";
require_once  BASE_PATH .   "controlador/EspecialistaController.php";
require_once  BASE_PATH .   "controlador/ProductoController.php";
require_once  BASE_PATH .   "controlador/ServicioController.php";
require_once  BASE_PATH .   "controlador/Nota_ventaController.php";
require_once  BASE_PATH .   "controlador/Ficha_consultaController.php";
...
if (
    !isset($_POST['id_venta']) && isset($_POST['id_paciente']) && isset($_POST['id_especialista']) && isset($_POST['observacion'])
...
if (
    !isset($_POST['id_consulta']) && isset($_POST['id_paciente']) && isset($_POST['id_especialista']) && isset($_POST['estado'])
    && isset($_POST['monto']) && isset($_POST['detalle'])
) {
    $id_paciente = $_POST['id_paciente'];
    $id_especialista = $_POST['id_especialista'];
