...
require_once BASE_PATH . "modelo/MPaciente.php";
require_once BASE_PATH . "modelo/MEspecialista.php";
require_once BASE_PATH . "modelo/MServicio.php";
...
class VFicha_consulta{
    ...
    public function index(){
        ...
        require_once BASE_PATH . "public/views/consulta/index.php";
    }
    ...
    public function new(){
        ...
        require_once BASE_PATH . "public/views/layout/nav.php";
        require_once BASE_PATH . "public/views/consulta/new.php";
    }
